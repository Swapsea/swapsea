...
RSpec.describe EventLogsController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: event_log.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      event_log = EventLog.create! valid_attributes
      get :edit, params: {id: event_log.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new EventLog" do
        expect {
          post :create, params: {event_log: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {event_log: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested event_log" do
        event_log = EventLog.create! valid_attributes
        put :update, params: {id: event_log.to_param, event_log: new_attributes}, session: valid_session
        event_log.reload
      ...
      it "redirects to the event_log" do
        event_log = EventLog.create! valid_attributes
        put :update, params: {id: event_log.to_param, event_log: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        event_log = EventLog.create! valid_attributes
        put :update, params: {id: event_log.to_param, event_log: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested event_log" do
      event_log = EventLog.create! valid_attributes
      expect {
        delete :destroy, params: {id: event_log.to_param}, session: valid_session
      }.to change(EventLog, :count).by(-1)
    end
