...
class ChangesControllerTest < ActionController::TestCase
  ...
  test "should create change" do
    assert_difference('Change.count') do
      post :create, change: { on_off_patrol: @change.on_off_patrol, roster_id: @change.roster_id, user_id: @change.user_id }
    end
  ...
  test "should update change" do
    patch :update, id: @change, change: { on_off_patrol: @change.on_off_patrol, roster_id: @change.roster_id, user_id: @change.user_id }
    assert_redirected_to change_path(assigns(:change))
  end
