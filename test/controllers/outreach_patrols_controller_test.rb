...
class OutreachPatrolsControllerTest < ActionController::TestCase
  ...
  test "should create outreach_patrol" do
    assert_difference('OutreachPatrol.count') do
      post :create, outreach_patrol: { finish: @outreach_patrol.finish, location: @outreach_patrol.location, start: @outreach_patrol.start }
    end
  ...
  test "should show outreach_patrol" do
    get :show, id: @outreach_patrol
    assert_response :success
  end

  test "should get edit" do
    get :edit, id: @outreach_patrol
    assert_response :success
  end

  test "should update outreach_patrol" do
    patch :update, id: @outreach_patrol, outreach_patrol: { finish: @outreach_patrol.finish, location: @outreach_patrol.location, start: @outreach_patrol.start }
    assert_redirected_to outreach_patrol_path(assigns(:outreach_patrol))
  end

  test "should destroy outreach_patrol" do
    assert_difference('OutreachPatrol.count', -1) do
      delete :destroy, id: @outreach_patrol
    end
